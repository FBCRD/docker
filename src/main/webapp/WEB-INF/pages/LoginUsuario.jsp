...
<div class="container">
    <div class="div_cadastro">
        ...
        <div class="cad">
            ...
            <h1 class="red-hat-display">Login</h1>
            <form action="login" method="Post">
                ...
                <div class="sectionforms">
                    ...
                    <input type="password" class="caixaforms" name="senha" id="senha" placeholder="senha"
                           >
                </div>

                <input type="submit" class="botao" value="Login">
            </form>
            <p><a href="pagCadastro">Ainda não possui conta? Cadastre-se</a></p>
